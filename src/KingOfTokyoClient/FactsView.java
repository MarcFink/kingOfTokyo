package KingOfTokyoClient;
	...
	public class FactsView{
		 ...
		 */
		 ...
		 private Scene scene;
		 TabPane tabpane;
		 BorderPane root, borderAbout;
		 Tab tabAboutUs;

		public FactsView(){
			//Mainpane wird erstellt
			...
			//tabpane wird erstellt	
		
			tabpane = new TabPane();
			tabpane.setPrefHeight(200);
			tabpane.setPrefWidth(200);
			//tabpane wird zur Mainpane erstellt
			root.setCenter(tabpane);
			root.setPrefHeight(500);
			root.setPrefWidth(900);

			tabAboutUs = new Tab("Über uns");
			borderAbout = new BorderPane();
			...
			//inhalt wird in tabpane eingefügt.
